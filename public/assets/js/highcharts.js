...
(function(P, M) {
  "object" === typeof module && module.exports
    ? ((M["default"] = M), (module.exports = P.document ? M(P) : M))
  ...
  M(I, "parts/Utilities.js", [I["parts/Globals.js"]], function(c) {
    ...
    function H(a, d, e) {
      ...
      F(d)
        ? C(e)
          ? a.setAttribute(d, e)
          : a && a.getAttribute && ((b = a.getAttribute(d)) || "class" !== d || (b = a.getAttribute(d + "Name")))
        : n(d, function(d, e) {
            a.setAttribute(e, d);
          });
      return b;
    ...
    c.Fx.prototype = {
      ...
      run: function(a, d, e) {
        ...
        a !== d || this.elem["forceAnimate:" + this.prop]
          ? ((this.startTime = +new Date()),
            ...
            (h.elem = this.elem),
            (h.prop = this.prop),
            h() && 1 === c.timers.push(h) && p(u))
          : (delete g.curAnim[this.prop],
      ...
      step: function(a) {
        ...
        if (b.attr && !b.element) a = !1;
          ...
          (this.pos = e.easing((d - this.startTime) / c)),
      ...
      initPath: function(a, d, e) {
        ...
        function c(a, d) {
          for (var e = (h - a.length) / r; 0 < e && e--; )
            (x = a.slice().splice(a.length / m - r, r * m)),
              (x[0] = d[h - r - e * r]),
    ...
    c.formatSingle = function(a, d, e) {
      ...
      /f$/.test(a)
        ? ((e = (e = a.match(b)) ? e[1] : -1),
          null !== d && (d = c.numberFormat(d, e, g.decimalPoint, -1 < a.indexOf(",") ? g.thousandsSep : "")))
        : (d = (e || c.time).dateFormat(a, d));
      return d;
    };
    ...
    c.normalizeTickInterval = function(a, d, e, b, g) {
      ...
      var p = a / e;
      d ||
        ((d = g ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
        !1 === b &&
          (1 === e
      ...
      for (
        b = 0;
        b < d.length && !((l = d[b]), (g && l * e >= a) || (!g && p <= (d[b] + (d[b + 1] || d[b])) / 2));
        b++
      );
      return (l = c.correctFloat(l * e, -Math.round(Math.log(0.001) / Math.LN10)));
    };
    ...
    c.numberFormat = function(a, d, b, l) {
      ...
      if (-1 === d) d = Math.min(g, 20);
        ...
        var u = d + +p[1];
        0 <= u
          ? ((p[0] = (+p[0]).toExponential(u).split("e")[0]), (d = u))
          : ((p[0] = p[0].split(".")[0] || 0), (a = 20 > d ? (p[0] * Math.pow(10, p[1])).toFixed(d) : 0), (p[1] = 0));
      }
    ...
    c.getStyle = function(a, d, e) {
      if ("width" === d)
        return (
          (d = Math.min(a.offsetWidth, a.scrollWidth)),
    ...
    c.addEvent = function(a, b, e, l) {
      ...
      var g =
        "function" === typeof a && a.prototype
          ? (a.prototype.protoEvents = a.prototype.protoEvents || {})
        ...
        e.target ||
          ...
          (function(b, l) {
            ...
            var k = 0,
              ...
              g = b.length + l.length;
            for (d = 0; d < g; d++)
              !1 === (b[k] ? (l[r] ? (b[k].order <= l[r].order ? b[k++] : l[r++]) : b[k++]) : l[r++]).fn.call(a, e) &&
                e.preventDefault();
    ...
    c.animate = function(a, b, e) {
      ...
      n(b, function(k, l) {
        ...
        h = null;
        "d" === l
          ? ((p.paths = p.initPath(a, a.d, b.d)), (p.toD = b.d), (d = 0), (h = 1))
          : a.attr
          ? (d = a.attr(l))
          : ((d = parseFloat(c.getStyle(a, l)) || 0), "opacity" !== l && (g = "px"));
        h || (h = k);
      ...
      (b.jQuery.fn.highcharts = function() {
        ...
        if (this[0])
          return a[0]
            ...
            : q[H(this[0], "data-highcharts-chart")];
      });
    return {
      arrayMax: function(a) {
    ...
    c.Color.prototype = {
      ...
      init: function(f) {
        ...
        if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops)
          this.stops = f.stops.map(function(f) {
          ...
          if (f && f.charAt && "#" === f.charAt()) {
            ...
            7 === C
              ? (t = [(f & 16711680) >> 16, (f & 65280) >> 8, f & 255, 1])
              : 4 === C &&
                (t = [
                  ((f & 3840) >> 4) | ((f & 3840) >> 8),
                  ((f & 240) >> 4) | (f & 240),
      ...
      tweenTo: function(c, f) {
        ...
        t.length && v && v.length
          ? ((c = 1 !== t[3] || 1 !== v[3]),
            (f =
              (c ? "rgba(" : "rgb(") +
              Math.round(t[0] + (v[0] - t[0]) * (1 - f)) +
              "," +
              Math.round(t[1] + (v[1] - t[1]) * (1 - f)) +
              "," +
              Math.round(t[2] + (v[2] - t[2]) * (1 - f)) +
              (c ? "," + (t[3] + (v[3] - t[3]) * (1 - f)) : "") +
              ")"))
          : (f = c.input || "none");
        return f;
  ...
  M(I, "parts/SvgRenderer.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    t(O.prototype, {
      ...
      animate: function(b, d, m) {
        ...
        0 !== D.duration
          ? (m && (D.complete = m), a(this, b, D))
          : (this.attr(b, void 0, m),
            h(
              b,
              function(a, b) {
      ...
      complexColor: function(a, b, d) {
        ...
        c.fireEvent(this.renderer, "complexColor", { args: arguments }, function() {
          ...
          e &&
            ...
            (g = a.stops),
            (p = d.radialReference),
            v(w) && (a[e] = w = { x1: w[0], y1: w[1], x2: w[2], y2: w[3], gradientUnits: "userSpaceOnUse" }),
            "radialGradient" === e &&
              p &&
              !G(w.gradientUnits) &&
              ((N = w), (w = A(w, D.getRadialAttr(p, N), { gradientUnits: "userSpaceOnUse" }))),
            h(w, function(a, b) {
              "id" !== b && J.push(b, a);
            }),
            h(g, function(a) {
            ...
            k[J]
              ...
              : ((w.id = K = c.uniqueKey()),
                ...
                g.forEach(function(a) {
                  0 === a[1].indexOf("rgba")
                    ? ((m = c.color(a[1])), (r = m.get("rgb")), (x = m.get("a")))
                    : ((r = a[1]), (x = 1));
                  a = D.createElement("stop")
                    .attr({ offset: a[0], "stop-color": r, "stop-opacity": x })
                    .add(l);
                  l.stops.push(a);
                })),
            (T = "url(" + D.url + "#" + K + ")"),
        ...
        if ((D = a[0]) && "none" !== D && c.svg) {
          ...
          a.forEach(function(a, e) {
            0 === e &&
              ...
              (e = b.getAttribute("y")),
              a.setAttribute("y", e || 0),
              null === e && b.setAttribute("y", 0));
            a = a.cloneNode(1);
            F(a, {
      ...
      attr: function(a, b, d, e) {
        ...
        "string" === typeof a
          ? (w = (this[a + "Getter"] || this._defaultGetter).call(this, a, D))
          : (h(
              a,
              function(b, d) {
                N = !1;
                ...
                N ||
                  ((k = this[d + "Setter"] || this._defaultSetter),
                  k.call(this, b, d, D),
                  !this.styledMode &&
                    this.shadows &&
                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(d) &&
                    this.updateShadows(d, b, k));
              },
              this
            ),
            this.afterSetters());
        ...
        u && "click" === a
          ? ((D.ontouchstart = function(a) {
            ...
            (D.onclick = function(a) {
              (-1 === Q.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (d.touchEventFired || 0)) &&
                b.call(D, a);
            }))
          : (D["on" + a] = b);
        return this;
      ...
      align: function(a, b, d) {
        ...
        var k, l;
        if (a) {
          if (((this.alignOptions = a), (this.alignByTranslate = b), !d || y(d)))
            (this.alignTo = e = d || "renderer"), B(w, this), w.push(this), (d = null);
      ...
      getBBox: function(a, b) {
        ...
        if (!d) {
          if (g || e.forExport) {
            try {
              (k =
                ...
                (d = m.getBBox ? t({}, m.getBBox()) : { width: m.offsetWidth, height: m.offsetHeight }),
                k && k("");
            } catch (aa) {
              ("");
            }
          ...
          e.isSVG &&
            ((a = d.width),
            (e = d.height),
            g && (d.height = e = { "11px,17": 14, "13px,20": 16 }[D && D.fontSize + "," + Math.round(e)] || e),
            b &&
              ((D = b * E),
              (d.width = Math.abs(e * Math.sin(D)) + Math.abs(a * Math.cos(D))),
      ...
      textSetter: function(a) {
        a !== this.textStr &&
          (delete this.bBox, delete this.textPxLength, (this.textStr = a), this.added && this.renderer.buildText(this));
      },
      ...
      zIndexSetter: function(a, b) {
        ...
        var l;
        G(a)
          ? (w.setAttribute("data-z-index", a), (a = +a), this[b] === a && (D = !1))
          : G(this[b]) && w.removeAttribute("data-z-index");
        this[b] = a;
        if (D) {
    ...
    O.prototype.translateXSetter = O.prototype.translateYSetter = O.prototype.rotationSetter = O.prototype.verticalAlignSetter = O.prototype.rotationOriginXSetter = O.prototype.rotationOriginYSetter = O.prototype.scaleXSetter = O.prototype.scaleYSetter = O.prototype.matrixSetter = function(
      a,
      b
    ) {
      this[b] = a;
    ...
    O.prototype["stroke-widthSetter"] = O.prototype.strokeSetter = function(a, b, d) {
      ...
      this.stroke && this["stroke-width"]
        ? (O.prototype.fillSetter.call(this, this.stroke, "stroke", d),
    ...
    t(f.prototype, {
      ...
      init: function(a, d, e, m, w, g, r) {
        ...
        this.alignedObjects = [];
        this.url =
          (k || x) && p.getElementsByTagName("base").length
            ? Q.location.href
                .split("#")[0]
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        this.createElement("desc")
          .add()
          .element.appendChild(p.createTextNode("Created with Highcharts 7.2.1"));
        ...
        k &&
          ...
          d(),
          (this.unSubPixelFix = b(Q, "resize", d)));
      },
      ...
      buildText: function(a) {
        ...
        var S = function(a) {
            var m;
            d.styledMode ||
              (m = /(px|em)$/.test(a && a.style.fontSize) ? a.style.fontSize : L || d.style.fontSize || 12);
        ...
        if (t !== a.textCache) {
          ...
          w || K || A || c || (-1 !== m.indexOf(" ") && (!u || Q.test(m)))
            ? (r && r.appendChild(b),
              w
                ? ((m = d.styledMode
                    ? m
              ...
              m.forEach(function(m, w) {
                ...
                x.forEach(function(m) {
                  if ("" !== m || 1 === x.length) {
                    ...
                    (n = O(m, "href")) &&
                      !e &&
                      (F(N, "onclick", 'location.href="' + n + '"'),
                      F(N, "class", "highcharts-anchor"),
                      d.styledMode || l(N, { cursor: "pointer" }));
                    ...
                    if (" " !== m) {
                      ...
                      if (c) {
                        ...
                        var f = S(N);
                        if (A)
                          D = d.truncate(a, N, m, void 0, 0, Math.max(0, c - parseInt(L || 12, 10)), function(a, b) {
                          ...
                          for (; T.length; )
                            T.length &&
                              !u &&
                              0 < n &&
                              ((N = p.createElementNS(U, "tspan")),
                              F(N, { dy: f, x: g }),
                              h && F(N, "style", h),
                              N.appendChild(p.createTextNode(T.join(" ").replace(/- /g, "-"))),
                              b.appendChild(N)),
                              d.truncate(a, N, null, T, 0 === n ? r : 0, c, function(a, b) {
                                return T.slice(0, b)
                                  .join(" ")
                                  .replace(/- /g, "-");
                              }),
              ...
              A && D && a.attr("title", v(a.textStr, ["&lt;", "&gt;"])),
              r && r.removeChild(b),
              K && a.applyTextOutline && a.applyTextOutline(K))
            : b.appendChild(p.createTextNode(v(m)));
        }
      },
      ...
      button: function(a, d, m, e, w, k, l, g, c, x) {
        ...
        D.setState = function(a) {
          1 !== a && (D.state = p = a);
          D.removeClass(/highcharts-button-(normal|hover|pressed|disabled)/).addClass(
      ...
      image: function(a, d, m, e, w, k) {
        ...
        k
          ? (g(c.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
            (l = new Q.Image()),
            b(l, "load", r),
            (l.src = a),
            l.complete && r({}))
        ...
        if (x) {
          ...
          ["width", "height"].forEach(function(a) {
            J[a + "Setter"] = function(a, b) {
              ...
              G(m) &&
                (k &&
                  "within" === k.backgroundSize &&
                  this.width &&
                  this.height &&
                  (m = Math.round(m * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                this.element && this.element.setAttribute(b, m),
                this.alignByTranslate || ((d[e] = ((this[b] || 0) - m) / 2), this.attr(d)));
            };
          });
          G(b) && J.attr({ x: b, y: m });
          J.isImg = !0;
          G(J.imgwidth) && G(J.imgheight)
            ? h()
            : (J.attr({ width: 0, height: 0 }),
              L("img", {
                onload: function() {
                  var a = d[g.chartIndex];
                  0 === this.width && (l(this, { position: "absolute", top: "-999em" }), p.body.appendChild(this));
      ...
      symbols: {
        circle: function(a, b, d, m) {
          return this.arc(a + d / 2, b + m / 2, d / 2, m / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
        },
        ...
        arc: function(a, b, d, m, e) {
          var w = e.start,
            ...
            g = e.end - 0.001;
          d = e.innerR;
          m = n(e.open, 0.001 > Math.abs(e.end - e.start - 2 * Math.PI));
          var r = Math.cos(w),
            c = Math.sin(w),
            x = Math.cos(g);
          g = Math.sin(g);
          w = 0.001 > e.end - w - Math.PI ? 0 : 1;
        ...
        callout: function(a, b, d, m, e) {
          ...
          l && l > d
            ? e > b + k && e < b + m - k
              ? g.splice(13, 3, "L", a + d, e - 6, a + d + 6, e, a + d, e + 6, a + d, b + m - w)
              : g.splice(13, 3, "L", a + d, m / 2, l, e, a + d, m / 2, a + d, b + m - w)
            : l && 0 > l
            ? e > b + k && e < b + m - k
              ? g.splice(33, 3, "L", a, e + 6, a - 6, e, a, e - 6, a, b + w)
              : g.splice(33, 3, "L", a, m / 2, l, e, a, m / 2, a, b + w)
            : e && e > m && l > a + k && l < a + d - k
            ? g.splice(23, 3, "L", l + 6, b + m, l, b + m + 6, l - 6, b + m, a + w, b + m)
            : e && 0 > e && l > a + k && l < a + d - k && g.splice(3, 3, "L", l - 6, b, l, b - 6, l + 6, b, d - w, b);
          return g;
        }
      },
      clipRect: function(a, b, d, m) {
        var e = c.uniqueKey() + "-",
          w = this.createElement("clipPath")
            .attr({ id: e })
            .add(this.defs);
      ...
      fontMetrics: function(a, b) {
        a =
          (!this.styledMode && /px/.test(a)) || !Q.getComputedStyle
      ...
      label: function(a, b, d, e, w, k, l, g, r) {
        var c = this,
          ...
          p = (J.text = c.text("", 0, 0, l).attr({ zIndex: 1 })),
          K,
          h,
          D = 0,
          u = 3,
        ...
        var R = function() {
          ...
          Q &&
            (K ||
              ((J.box = K = c.symbols[e] || v ? c.symbol(e) : c.rect()),
              K.addClass(("button" === r ? "" : "highcharts-label-box") + (r ? " highcharts-" + r + "-box" : "")),
              K.add(J),
              (a = y()),
              (b.x = a),
              (b.y = (g ? -S : 0) + a)),
            (b.width = Math.round(J.width)),
            (b.height = Math.round(J.height)),
            K.attr(t(b, q)),
            (q = {}));
        };
        var B = function() {
          var a = L + u;
          var b = g ? 0 : S;
          G(n) && h && ("center" === f || "right" === f) && (a += { center: 0.5, right: 1 }[f] * (n - h.width));
          if (a !== p.x || b !== p.y)
            p.attr("x", a), p.hasBoxWidthChanged && ((h = p.getBBox(!0)), R()), void 0 !== b && p.attr("y", b);
          p.x = a;
          p.y = b;
        };
        var V = function(a, b) {
  ...
  M(I, "parts/Html.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
        ...
        if (this.added) {
          ...
          if ("SPAN" === b.tagName) {
            ...
            var k = this.textWidth && t(this.textWidth),
              ...
              x;
            (x = k !== this.oldTextWidth) &&
              !(x = k > this.oldTextWidth) &&
              ((x = this.textPxLength) || (C(b, { width: "", whiteSpace: u || "nowrap" }), (x = b.offsetWidth)),
              (x = x > k));
            x && (/[ \-]/.test(b.textContent || b.innerText) || "ellipsis" === b.style.textOverflow)
              ? (C(b, { width: k + "px", display: "block", whiteSpace: u || "normal" }),
                (this.oldTextWidth = k),
                (this.hasBoxWidthChanged = !0))
              : (this.hasBoxWidthChanged = !1);
            r !== this.cTT &&
              ((u = g.fontMetrics(b.style.fontSize, b).b),
              !G(p) || (p === (this.oldRotation || 0) && c === this.oldAlign) || this.setSpanRotation(p, h, u),
              this.getSpanCorrection((!G(p) && this.textPxLength) || b.offsetWidth, u, h, p, c));
    ...
    z(f.prototype, {
      getTransformKey: function() {
        return y && !/Edge/.test(q.navigator.userAgent)
          ? "-ms-transform"
          : h
          ? "-webkit-transform"
          : H
  ...
  M(I, "parts/Time.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.Time.prototype = {
      ...
      update: function(c) {
        ...
        (this.variableTimezone = !(h && !c.getTimezoneOffset && !c.timezone)) || this.timezoneOffset
          ? ((this.get = function(g, b) {
            ...
            (this.set = function(g, b, a) {
              if ("Milliseconds" === g || "Seconds" === g || ("Minutes" === g && 0 === b.getTimezoneOffset() % 60))
                b["set" + g](a);
              else {
            ...
            a.push(n),
              (n =
                l === H.year
                  ...
                  : !E || (l !== H.day && l !== H.week)
                  ? E && l === H.hour && 1 < h
                    ? b.makeTime(p, g, u, k + e * h)
                    : n + l * h
                  : b.makeTime(p, g, u + e * h * (l === H.day ? 1 : 7))),
              e++;
          a.push(n);
          l <= H.hour &&
            1e4 > a.length &&
    ...
    c.Tick.prototype = {
      addLabel: function() {
        ...
        if ((k = r && r.list))
          c.shortenLabel = function() {
            for (u = 0; u < k.length; u++)
              if (
                (p.attr({ text: n.labelFormatter.call(z(c.formatCtx, { dateTimeLabelFormat: k[u] })) }),
                p.getBBox().width < n.getSlotWidth(c) - 2 * t(e.padding, 5))
              )
                return;
            p.attr({ text: "" });
          };
        if (F(p))
          p &&
            p.textStr !== f &&
            (!p.textWidth || (e.style && e.style.width) || p.styles.width || p.css({ width: null }),
            p.attr({ text: f }),
            (p.textPxLength = p.getBBox().width));
        else {
          if ((c.label = p = F(f) && e.enabled ? g.renderer.text(f, 0, 0, e.useHTML).add(n.labelGroup) : null))
            g.styledMode || p.css(H(e.style)), (p.textPxLength = p.getBBox().width);
          c.rotation = 0;
        }
      },
      ...
      handleOverflow: function(c) {
        ...
        var e = this.label,
          l = this.rotation,
          L = { left: 0, center: 0.5, right: 1 }[h.labelAlign || e.attr("align")],
          E = e.getBBox().width,
          ...
          r,
          x = {};
        if (l || "justify" !== t(f.overflow, "justify"))
          0 > l && g - L * E < d
            ? (r = Math.round(g / Math.cos(l * y) - d))
            : 0 < l && g + L * E > a && (r = Math.round((b - g) / Math.cos(l * y)));
        else if (
          ((b = g + (1 - L) * E),
          g - L * E < d ? (u = c.x + u * (1 - L) - d) : b > a && ((u = a - c.x + u * L), (k = -1)),
          (u = Math.min(p, u)),
          u < p && "center" === h.labelAlign && (c.x += k * (p - u - L * (p - Math.min(E, u)))),
          E > u || (h.autoRotation && (e.styles || {}).width))
        )
          r = u;
        r &&
          (this.shortenLabel
            ? this.shortenLabel()
            : ((x.width = Math.floor(r)), (f.style || {}).textOverflow || (x.textOverflow = "ellipsis"), e.css(x)));
      },
      getPosition: function(h, n, f, g) {
        ...
        h = {
          x: h
            ? c.correctFloat(b.translate(n + f, null, null, g) + b.transB)
            : b.left + b.offset + (b.opposite ? ((g && a.oldChartWidth) || a.chartWidth) - b.right - b.left : 0),
          y: h
            ? d - b.bottom + b.offset - (b.opposite ? b.height : 0)
            : c.correctFloat(d - b.translate(n + f, null, null, g) - b.transB)
        };
      ...
      getLabelPosition: function(c, n, f, g, b, a, d, e) {
        var l = this.axis,
          ...
          k = b.y,
          r = g || l.reserveSpaceDefault ? 0 : -l.labelOffset * ("center" === l.labelAlign ? 0.5 : 1),
          x = {};
        F(k) ||
          (k =
            0 === l.side
              ...
              : 2 === l.side
              ? u.y + 8
              : Math.cos(f.rotation * y) * (u.y - f.getBBox(!1, 0).height / 2));
      ...
      renderGridLine: function(c, n, f) {
        ...
        b = b[p + "LineDashStyle"];
        a ||
          (g.chart.styledMode || ((d.stroke = k), (d["stroke-width"] = u), b && (d.dashstyle = b)),
          l || (d.zIndex = 1),
          c && (n = 0),
          (this.gridLine = a = E.path()
            .attr(d)
            .addClass("highcharts-" + (l ? l + "-" : "") + "grid-line")
            .add(g.gridGroup)));
        if (a && (f = g.getPlotLinePath({ value: e + h, lineWidth: a.strokeWidth() * f, force: "pass", old: c })))
        ...
        l &&
          ...
          E &&
            ((this.mark = h = a
              ...
              .add(g.axisGroup)),
            g.chart.styledMode || h.attr({ stroke: b, "stroke-width": u })),
      ...
      renderLabel: function(c, n, f, g) {
        ...
        e &&
          B(p) &&
          ((e.xy = c = this.getLabelPosition(p, c, e, a, l, b, g, h)),
          (this.isFirst && !this.isLast && !t(d.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !t(d.showLastLabel, 1))
            ? (E = !1)
            : !a || l.step || l.rotation || n || 0 === f || this.handleOverflow(c),
          h && g % h && (E = !1),
          E && B(c.y)
            ? ((c.opacity = f), e[this.isNewLabel ? "attr" : "animate"](c), (this.isNewLabel = !1))
            : (e.attr("y", -9999), (this.isNewLabel = !0)));
      },
  ...
  M(I, "parts/Axis.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    t(f.prototype, {
          ...
          a.series.forEach(function(m) {
            if (m.visible || !b.options.chart.ignoreHiddenSeries) {
              ...
              if (a.isXAxis) {
                ...
                z(k) &&
                  z(c) &&
                  ((a.dataMin = Math.min(h(a.dataMin, k), k)), (a.dataMax = Math.max(h(a.dataMax, c), c))),
                z(w) && (a.threshold = w),
      ...
      translate: function(a, b, d, e, k, c) {
        ...
        b
          ? ((a = (a * w + l - r) / g + e), k && (a = m.lin2val(a)))
          : (k && (a = m.val2lin(a)), (a = C(e) ? w * (a - e) * g + l + w * r + (C(c) ? g * c : 0) : void 0));
        return a;
      },
      ...
      getPlotLinePath: function(a) {
        ...
        L(this, "getPlotLinePath", a, function(a) {
          ...
          C(l)
            ? b.horiz
              ? ((p = w), (u = n - b.bottom), (x = A = v(x, e, e + b.width)))
              : ((x = e), (A = f - b.right), (p = u = v(p, w, w + b.height)))
            : ((E = !0), (r = !1));
      ...
      getMinorTickPositions: function() {
        ...
        if (g && g / e < a.len / 3)
          if (a.isLog)
            this.paddedTicks.forEach(function(b, d, m) {
              d && k.push.apply(k, a.getLogTickPositions(e, m[d - 1], m[d], !0));
            });
          else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
            k = k.concat(a.getTimeTicks(a.normalizeTimeTickInterval(e), l, c, b.startOfWeek));
      ...
      nameToX: function(a) {
        ...
        z(e) ||
          (e =
            !1 === this.options.uniqueNames ? a.series.autoIncrement() : b ? d.indexOf(a.name) : h(d.keys[a.name], -1));
        if (-1 === e) {
          if (!b) var k = d.length;
        } else k = e;
        ...
        if (r || l || e) {
          ...
          c
            ...
            : b.series.forEach(function(a) {
                ...
                e = Math.max(e, d);
                if (!b.single || l)
                  (a = x.xrange && a instanceof x.xrange ? !r : r),
      ...
      setTickInterval: function(a) {
        ...
        l &&
          (b.positiveValuesOnly && !a && 0 >= Math.min(b.min, h(b.dataMin, b.min)) && c.error(10, 1, e),
          (b.min = d(b.log2lin(b.min), 16)),
          (b.max = d(b.log2lin(b.max), 16)));
        b.range &&
          z(b.max) &&
          ((b.userMin = b.min = t = Math.max(b.dataMin, b.minFromRange())), (b.userMax = y = b.max), (b.range = null));
        L(b, "foundExtremes");
        b.beforePadding && b.beforePadding();
        b.adjustForMinRange();
        !(E || b.axisPointRange || b.usePercentage || x) &&
          z(b.min) &&
          z(b.max) &&
          (e = b.max - b.min) &&
          (!z(t) && u && (b.min -= e * u), !z(y) && A && (b.max += e * A));
        ...
        v &&
          z(b.dataMin) &&
          ((q = q || 0),
          !z(t) && b.min < q && b.dataMin >= q
            ? (b.min = b.options.minRange ? Math.min(q, b.max - b.minRange) : q)
            : !z(y) &&
              b.max > q &&
              b.dataMax <= q &&
              (b.max = b.options.minRange ? Math.max(q, b.min + b.minRange) : q));
        b.tickInterval =
          b.min === b.max || void 0 === b.min || void 0 === b.max
            ? 1
            : x && !n && f === b.linkedParent.options.tickPixelInterval
            ? (n = b.linkedParent.tickInterval)
            : h(
                n,
                this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                E ? 1 : ((b.max - b.min) * f) / Math.max(b.len, f)
              );
        r &&
          !a &&
          b.series.forEach(function(a) {
        ...
        g ||
          ...
          (b.tickInterval = k(
            ...
            null,
            p(b.tickInterval),
            h(w.allowDecimals, !(0.5 < b.tickInterval && 5 > b.tickInterval && 1e3 < b.max && 9999 > b.max)),
            !!this.tickAmount
          ));
      ...
      zoom: function(a, b) {
        ...
        L(this, "zoom", a, function(a) {
          var b = a.newMin,
            m = a.newMax;
          if (b !== this.min || m !== this.max)
            this.allowZoomOutside ||
              (z(d) && (b < k && (b = k), b > w && (b = w)), z(e) && (m < k && (m = k), m > w && (m = w))),
              (this.displayBtn = void 0 !== b || void 0 !== m),
              this.setExtremes(b, m, !1, void 0, { trigger: "zoom" });
          a.zoomed = !0;
        });
        return a.zoomed;
      },
      ...
      unsquish: function() {
        ...
        b
          ? (u = !a.staggerLines && !a.step && (z(r) ? [r] : c < h(a.autoRotationLimit, 80) && a.autoRotation)) &&
      ...
      getSlotWidth: function(a) {
        ...
        return (
          (a && a.slotWidth) ||
          (d && 2 > (e.step || 0) && !e.rotation && ((this.staggerLines || 1) * this.len) / k) ||
          (!d && ((e.style && parseInt(e.style.width, 10)) || (c && c - b.spacing[3]) || 0.33 * b.chartWidth))
        );
      },
      renderUnsquish: function() {
            ...
            for (r = d.length; !l && r--; ) {
              ...
              if ((f = e[f].label))
                f.styles && "ellipsis" === f.styles.textOverflow
                  ...
                  : f.textPxLength > g && f.css({ width: g + "px" }),
                  f.getBBox().height > this.len / d.length - (p.h - p.f) && (f.specificTextOverflow = "ellipsis");
            }
          }
        }
        x.rotation && ((u = A > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : A), h || (n = "ellipsis"));
        ...
        d.forEach(function(a) {
          ...
          b &&
            ...
            a.shortenLabel
              ? a.shortenLabel()
              : u && !d && "nowrap" !== c.whiteSpace && (u < b.textPxLength || "SPAN" === b.element.tagName)
              ? ((k.width = u), h || (k.textOverflow = b.specificTextOverflow || n), b.css(k))
              : b.styles && b.styles.width && !k.width && !d && b.css({ width: null }),
        ...
        this.axisTitle ||
          ((c = k.textAlign) ||
            (c = (d
              ...
              : { low: e ? "right" : "left", middle: "center", high: e ? "left" : "right" })[k.align]),
          (this.axisTitle = b
            .text(k.text, 0, 0, k.useHTML)
            .attr({ zIndex: 7, rotation: k.rotation || 0, align: c })
            .addClass("highcharts-axis-title")),
          l || this.axisTitle.css(u(k.style)),
      ...
      getOffset: function() {
        ...
        C || a.isLinked
          ? (k.forEach(function(b, d) {
            ...
            h(n.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
      ...
      getLinePath: function(a) {
        ...
        return b.renderer.crispLine(
          [
            ...
            k ? e : this.top,
            "L",
            k ? b.chartWidth - this.right : c,
            k ? e : b.chartHeight - this.bottom
          ],
          a
        );
      },
      ...
      getTitlePosition: function() {
        ...
        b =
          (a ? d + this.height : b) + (a ? 1 : -1) * (l ? -1 : 1) * this.axisTitleMargin + [-p, p, A.f, -p][this.side];
        a = { x: a ? e + r : b + (l ? this.width : 0) + g + r, y: a ? b + x - (l ? this.height : 0) + g : e + x };
      ...
      renderTick: function(a, b) {
        ...
        if (!d || (a >= this.min && a <= this.max))
          e[a] || (e[a] = new A(this, a)), k && e[a].isNew && e[a].render(b, !0, -1), e[a].render(b);
      },
      render: function() {
        var a = this,
          d = a.chart,
            ...
            n &&
              g.forEach(function(b, e) {
                ...
                0 === e % 2 &&
                  b < a.max &&
                  H <= a.max + (d.polar ? -f : f) &&
                  (h[b] || (h[b] = new c.PlotLineOrBand(a)),
                  (B = b + f),
                  (h[b].options = { from: k ? a.lin2log(B) : B, to: k ? a.lin2log(H) : H, color: n }),
                  h[b].render(),
                  (h[b].isActive = !0));
              }),
            a._addedPlotLB ||
        ...
        r &&
          v &&
          ((e = a.getTitlePosition()),
          C(e.y) ? (r[r.isNew ? "attr" : "animate"](e), (r.isNew = !1)) : (r.attr("y", -9999), (r.isNew = !0)));
      ...
      drawCrosshair: function(b, d) {
        ...
        if (this.crosshair && !1 !== (z(d) || !c)) {
          c
            ? z(d) &&
              (l = h("colorAxis" !== this.coll ? d.crosshairPos : null, this.isXAxis ? d.plotX : this.len - d.plotY))
            : (l = b && (this.horiz ? b.chartX - this.pos : this.len - b.chartY + this.pos));
          z(l) &&
            (e =
              this.getPlotLinePath({ value: d && (this.isXAxis ? d.x : h(d.stackY, d.y)), translatedValue: l }) ||
              null);
          if (!z(e)) {
            this.hideCrosshair();
            return;
          ...
          g ||
            ((this.cross = g = this.chart.renderer
              .path()
              .addClass("highcharts-crosshair highcharts-crosshair-" + (c ? "category " : "thin ") + k.className)
              .attr({ zIndex: h(k.zIndex, 2) })
              .add()),
            this.chart.styledMode ||
              (g
                .attr({
              ...
              k.dashStyle && g.attr({ dashstyle: k.dashStyle })));
          g.show().attr({ d: e });
  ...
  M(I, "parts/DateTimeAxis.js", [I["parts/Globals.js"]], function(c) {
    ...
    f.prototype.normalizeTimeTickInterval = function(c, f) {
      ...
      for (
        y = 0;
        y < v.length &&
        !((f = v[y]), (t = z[f[0]]), (B = f[1]), v[y + 1] && c <= (t * B[B.length - 1] + z[v[y + 1][0]]) / 2);
        y++
      );
  ...
  M(I, "parts/LogarithmicAxis.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    f.prototype.getLogTickPositions = function(c, f, v, C) {
      ...
      if (0.5 <= c) (c = Math.round(c)), (h = this.getLinearTickPositions(c, f, v));
      else if (0.08 <= c) {
        y = Math.floor(f);
        var n, q;
        for (t = 0.3 < c ? [1, 2, 4] : 0.15 < c ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; y < v + 1 && !q; y++) {
          var g = t.length;
          for (n = 0; n < g && !q; n++) {
        ...
        (f = this.lin2log(f)),
          ...
          (c = F(
            ...
            ((t.tickPixelInterval / (C ? 5 : 1)) * (v - f)) / ((C ? y / this.tickPositions.length : y) || 1)
          )),
          (c = z(c, null, G(c))),
  ...
  M(I, "parts/PlotLineOrBand.js", [I["parts/Globals.js"], I["parts/Axis.js"], I["parts/Utilities.js"]], function(
    c,
    f,
    F
  ) {
    ...
    c.PlotLineOrBand.prototype = {
      render: function() {
        ...
        q.chart.styledMode ||
          (p
            ? ((r.stroke = x || "#999999"),
              (r["stroke-width"] = y(b.width, 1)),
              b.dashStyle && (r.dashstyle = b.dashStyle))
            : E &&
              ((r.fill = x || "#e6ebf5"),
              b.borderWidth && ((r.stroke = b.borderColor), (r["stroke-width"] = b.borderWidth))));
        m.zIndex = A;
        J += "-" + A;
        (x = q.plotLinesAndBandsGroups[J]) ||
          (q.plotLinesAndBandsGroups[J] = x = K.g("plot-" + J)
            .attr(m)
            .add());
        k &&
          (f.svgElem = u = K.path()
            .attr(r)
            .add(x));
        if (p) r = q.getPlotLinePath({ value: L, lineWidth: u.strokeWidth(), acrossPanes: b.acrossPanes });
        ...
        a && (B(a.text) || B(a.formatter)) && r && r.length && 0 < q.width && 0 < q.height && !r.isFlat
          ? ((a = h(
              {
                align: g && E && "center",
                x: g ? !E && 4 : 10,
  ...
  M(I, "parts/Tooltip.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.Tooltip.prototype = {
      ...
      getLabel: function() {
        ...
        if (!this.label) {
          this.outside &&
            ((this.container = l = c.doc.createElement("div")),
            (l.className = "highcharts-tooltip-container"),
            c.css(l, { position: "absolute", top: "1px", pointerEvents: d.style && d.style.pointerEvents, zIndex: 3 }),
            c.doc.body.appendChild(l),
            (this.renderer = b = new c.Renderer(l, 0, 0, {}, void 0, void 0, b.styledMode)));
          this.split
            ? (this.label = b.g(e))
            : ((this.label = b
                .label("", 0, 0, d.shape || "callout", null, null, d.useHTML, null, e)
                .attr({ padding: d.padding, r: d.borderRadius })),
              a ||
                this.label
                  .attr({ fill: d.backgroundColor, "stroke-width": d.borderWidth })
                  .css(d.style)
                  .shadow(d.shadow));
      ...
      getAnchor: function(c, b) {
        ...
        this.followPointer && b
          ? (void 0 === b.chartX && (b = d.normalize(b)), (c = [b.chartX - a.plotLeft, b.chartY - l]))
          : c[0].tooltipPos
          ? (c = c[0].tooltipPos)
          : (c.forEach(function(a) {
            ...
            (c = [
              e ? a.plotWidth - p : h,
              this.shared && !e && 1 < c.length && b ? b.chartY - l : e ? a.plotHeight - h : p
            ]));
      ...
      getPosition: function(c, b, a) {
        var d = this.chart,
          ...
          m = function(l) {
            var m = "x" === l;
            return [l, m ? f : k, m ? c : b].concat(
              p
                ? [
                    m ? A(c) : w(b),
                    m ? r.left - e + A(a.plotX + d.plotLeft) : r.top - e + w(a.plotY + d.plotTop),
                    0,
                    m ? f : k
                  ]
                : [
                    m ? c : b,
                    m ? a.plotX + d.plotLeft : a.plotY + d.plotTop,
                    m ? d.plotLeft : d.plotTop,
                    m ? d.plotLeft + d.plotWidth : d.plotTop + d.plotHeight
                  ]
            );
          },
          n = m("y"),
      ...
      refresh: function(g, b) {
        ...
        if (d.enabled) {
          ...
          b = u[0];
          var k = u[1];
          !l || (e.series && e.series.noSharedTooltip)
            ? (l = e.getLabelConfig())
            : (a.pointer.applyInactiveState(e),
              e.forEach(function(a) {
                a.setState("hover");
                h.push(a.getLabelConfig());
              }),
              (l = { x: e[0].category, y: e[0].y }),
              (l.points = h),
              (e = e[0]));
          this.len = h.length;
          a = f.call(l, this);
          ...
          !1 === a
            ? this.hide()
            : (this.split
                ? this.renderSplit(a, C(g))
                : ((g = this.getLabel()),
                  (d.style.width && !p) || g.css({ width: this.chart.spacingBox.width }),
                  g.attr({ text: a && a.join ? a.join("") : a }),
                  g
                    .removeClass(/highcharts-color-[\d]+/g)
                    .addClass("highcharts-color-" + v(e.colorIndex, f.colorIndex)),
                  p || g.attr({ stroke: d.borderColor || e.color || f.color || "#666666" }),
                  this.updatePosition({ plotX: b, plotY: k, negative: e.negative, ttBelow: e.ttBelow, h: u[2] || 0 })),
      ...
      renderSplit: function(g, b) {
        ...
        g.slice(0, b.length + 1).forEach(function(c, m) {
          if (!1 !== c && "" !== c) {
            ...
            x ||
              ((x = { padding: f.padding, r: f.borderRadius }),
              e.styledMode || ((x.fill = f.backgroundColor), (x["stroke-width"] = f.borderWidth)),
              (g.tt = x = l
                .label(null, null, null, (m.isHeader ? f.headerShape : f.shape) || "callout", null, null, f.useHTML)
                .addClass(m.isHeader ? "highcharts-tooltip-header " : "highcharts-tooltip-box " + A)
                .attr(x)
                .add(k)));
            x.isActive = !0;
            x.attr({ text: c });
            e.styledMode ||
              x
                .css(f.style)
                .shadow(f.shadow)
                .attr({ stroke: f.borderColor || m.color || w.color || "#333333" });
            c = x.getBBox();
            A = c.width + x.strokeWidth();
            m.isHeader
              ? ((p = c.height),
                e.xAxis[0].opposite && ((u = !0), (r -= p)),
                (c = Math.max(
                  0,
                  Math.min(
                    m.plotX + e.plotLeft - A / 2,
                    e.chartWidth + (e.scrollablePixelsX ? e.scrollablePixelsX - e.marginRight : 0) - A
                  )
                )))
              : (c = m.plotX + e.plotLeft - v(f.distance, 16) - A);
            0 > c && (h = !1);
            m.isHeader
              ? (w = u ? -p : e.plotHeight + p)
              : ((w = w.yAxis), (w = w.pos - r + Math.max(0, Math.min(m.plotY || 0, w.len))));
            d.push({ target: w, rank: m.isHeader ? 1 : 0, size: g.tt.getBBox().height + 1, point: m, x: c, tt: x });
          }
        });
        this.cleanSplit();
        f.positioner &&
      ...
      updatePosition: function(g) {
        ...
        if (this.outside) {
          ...
          if ((b = b.containerScaling))
            c.css(this.container, { transform: "scale(" + b.scaleX + ", " + b.scaleY + ")" }),
              (e *= b.scaleX),
              (l *= b.scaleY);
          e += a.left - g.x;
          l += a.top - g.y;
      ...
      bodyFormatter: function(c) {
        return c.map(function(b) {
          ...
          return (a[(b.point.formatPrefix || "point") + "Formatter"] || b.point.tooltipFormatter).call(
            b.point,
  ...
  M(I, "parts/Pointer.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.Pointer.prototype = {
      ...
      getChartCoordinatesFromPoint: function(a, b) {
        ...
        if (e && d)
          return b
            ? { chartX: e.len + e.pos - c, chartY: d.len + d.pos - a.plotY }
      ...
      getHoverData: function(a, b, d, c, h, f) {
        ...
        e &&
          (h && !b.noSharedTooltip
            ? ((x = d.filter(function(a) {
                return (
                  a.visible && !(!h && a.directTouch) && C(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                );
              })),
      ...
      runPointActions: function(a, b) {
        ...
        k = this.getHoverData(
          ...
          k,
          d.series,
          (!a || "touchmove" !== a.type) && (!!b || (k && k.directTouch && this.isDirectTouch)),
          l,
          a
        );
        g = k.hoverPoint;
        ...
        if (g && (g !== d.hoverPoint || (e && e.isHidden))) {
          ...
          d.hoverPoint = g;
          e && e.refresh(l ? r : g, a);
        } else b && e && !e.isHidden && ((g = e.getAnchor([{}], a)), e.updatePosition({ plotX: g[0], plotY: g[1] }));
        this.unDocMouseMove ||
          (this.unDocMouseMove = y(d.container.ownerDocument, "mousemove", function(a) {
      ...
      scaleGroups: function(a, b) {
        ...
        d.series.forEach(function(c) {
          ...
          c.xAxis &&
            ...
            c.group &&
            (c.group.attr(e),
            c.markerGroup && (c.markerGroup.attr(e), c.markerGroup.clip(b ? d.clipRect : null)),
            c.dataLabelsGroup && c.dataLabelsGroup.attr(e));
        });
      ...
      drag: function(a) {
        ...
        if (!m || !m.touch)
          if (
            (e < r ? (e = r) : e > r + A && (e = r + A),
            c < h ? (c = h) : c > h + w && (c = h + w),
            (this.hasDragged = Math.sqrt(Math.pow(f - e, 2) + Math.pow(J - c, 2))),
            10 < this.hasDragged)
          ) {
      ...
      drop: function(a) {
        ...
        e &&
          B(e.index) &&
          (q(e.container, { cursor: e._cursor }),
      ...
      onContainerMouseMove: function(a) {
        var b = this.chart;
        (G(c.hoverChartIndex) && h[c.hoverChartIndex] && h[c.hoverChartIndex].mouseIsDown) ||
      ...
      onContainerClick: function(a) {
        ...
        d.cancelClick ||
          (e && this.inClass(a.target, "highcharts-tracker")
            ? (b(e.series, "click", z(a, { point: e })), d.hoverPoint && e.firePointEvent("click", a))
            : (z(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX - c, a.chartY - g) && b(d, "click", a)));
      },
  ...
  M(I, "parts/TouchPointer.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    F(c.Pointer.prototype, {
      ...
      pinchTranslateDirection: function(c, f, C, B, y, h, n, q) {
        ...
        K ? ((A -= 0.8 * (A - n[b][0])), r || (m -= 0.8 * (m - n[b][1])), C()) : (n[b] = [A, m]);
        u || ((h[b] = t - l), (h[e] = v));
        h = u ? 1 / p : p;
        y[e] = v;
        y[b] = f;
      ...
      pinch: function(c) {
        ...
        "touchstart" === c.type
          ? ([].forEach.call(y, function(a, b) {
            ...
            (n.x = [z[0].chartX, z[1] && z[1].chartX]),
            (n.y = [z[0].chartY, z[1] && z[1].chartY]),
            ...
            (f.res = !0))
          : f.followTouchMove && 1 === h
          ? this.runPointActions(f.normalize(c))
          : z.length &&
            (g || (f.selectionMarker = g = F({ destroy: B, touch: !0 }, t.plotBox)),
            f.pinchTranslate(z, y, b, g, d, n),
            (f.hasPinched = q),
            f.scaleGroups(b, d),
      ...
      touch: function(f, v) {
        ...
        if (1 === f.touches.length)
          if (
            ((f = this.normalize(f)), (z = t.isInsidePlot(f.chartX - t.plotLeft, f.chartY - t.plotTop)) && !t.openMenu)
          ) {
            v && this.runPointActions(f);
            if ("touchmove" === f.type) {
              v = this.pinchDown;
              var y = v[0]
                ? 4 <= Math.sqrt(Math.pow(v[0].chartX - f.chartX, 2) + Math.pow(v[0].chartY - f.chartY, 2))
                : !1;
            }
            G(y, !0) && this.pinch(f);
          } else v && this.reset();
      ...
      var n = {},
        ...
        b = function(a, b, e, l) {
          ("touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH) ||
            !B[c.hoverChartIndex] ||
            (l(a),
            (l = B[c.hoverChartIndex].pointer),
            l[b]({ type: e, target: a.currentTarget, preventDefault: C, touches: g() }));
        };
      F(f.prototype, {
    ...
    c.Legend.prototype = {
      init: function(b, a) {
        ...
        a.enabled &&
          ...
          this.proximate
            ? (this.unchartrender = v(this.chart, "render", function() {
      ...
      setOptions: function(b) {
        ...
        this.options = b;
        this.chart.styledMode ||
          ((this.itemStyle = b.itemStyle), (this.itemHiddenStyle = h(this.itemStyle, b.itemHiddenStyle)));
      ...
      renderItem: function(b) {
        ...
        r ||
          ((b.legendGroup = d
            ...
            .addClass(
              "highcharts-" +
                ...
                b.colorIndex +
                (n ? " " + n : "") +
                (x ? " highcharts-series-" + b.index : "")
            )
            .attr({ zIndex: 1 })
            .add(this.scrollGroup)),
          (b.legendItem = r = d.text("", k ? c + g : -g, this.baseline || 0, m)),
          a.styledMode || r.css(h(b.visible ? f : p)),
          r.attr({ align: k ? "left" : "right", zIndex: 2 }).add(b.legendGroup),
          this.baseline ||
            ((this.fontMetrics = d.fontMetrics(a.styledMode ? 12 : f.fontSize, r)),
          ...
          A.drawLegendSymbol(this, b),
          this.setItemEvents && this.setItemEvents(b, r, m));
      ...
      adjustMargins: function(b, a) {
        var d = this.chart,
          ...
          c = this.getAlignment();
        c &&
          [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function(g, l) {
            g.test(c) &&
              !F(b[l]) &&
              (d[y[l]] = Math.max(
                d[y[l]],
      ...
      proximatePositions: function() {
        ...
        this.allItems.forEach(function(e) {
          ...
          if (e.yAxis && e.points) {
            ...
            e.visible ? ((h = h ? h.plotY : e.yAxis.height), (h += f - 0.3 * g)) : (h = f + e.yAxis.height);
      ...
      render: function() {
        ...
        b.styledMode ||
          g
            .attr({ stroke: f.borderColor, "stroke-width": f.borderWidth || 0, fill: f.backgroundColor || "none" })
            .shadow(f.shadow);
        0 < p &&
          0 < u &&
          (g[g.isNew ? "attr" : "animate"](g.crisp.call({}, { x: 0, y: 0, width: p, height: u }, g.strokeWidth())),
          (g.isNew = !1));
        g[e ? "show" : "hide"]();
        ...
        e &&
          ...
          /(lth|ct|rth)/.test(this.getAlignment()) && 0 < b.titleOffset[0]
            ? (g += b.titleOffset[0])
            : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < b.titleOffset[2] && (g -= b.titleOffset[2]),
          g !== a.y && (a = h(a, { y: g })),
          d.align(h(f, { width: p, height: u, verticalAlign: this.proximate ? "top" : f.verticalAlign }), !0, a));
      ...
      handleOverflow: function(b) {
        ...
        var f = c.maxHeight,
          ...
          J = this.allItems,
          q = function(b) {
            "number" === typeof b ? k.attr({ height: b }) : k && ((a.clipRect = k.destroy()), a.contentGroup.clip());
            a.contentGroup.div &&
        ...
        m.length = 0;
        b > g && !1 !== r.enabled
          ? ((this.clipHeight = u = Math.max(g - 20 - this.titleHeight - h, 0)),
            ...
            k || ((k = a.clipRect = e.clipRect(0, h, 9999, 0)), a.contentGroup.clip(k)),
            q(u),
            w ||
              ((this.nav = w = e
                .g()
                .attr({ zIndex: 1 })
                .add(this.group)),
              (this.up = e.symbol("triangle", 0, 0, A, A).add(w)),
              v("upTracker").on("click", function() {
                a.scroll(-1, x);
              }),
              (this.pager = e.text("", 15, 10).addClass("highcharts-legend-navigation")),
              d.styledMode || this.pager.css(r.style),
              this.pager.add(w),
              (this.down = e.symbol("triangle-down", 0, 0, A, A).add(w)),
              v("downTracker").on("click", function() {
                a.scroll(1, x);
              })),
            a.scroll(0),
            (b = g))
          : w && (q(), (this.nav = w.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
        return b;
      },
      scroll: function(b, a) {
        var d = this.pages,
        ...
        c > e && (c = e);
        0 < c &&
          (void 0 !== a && t(a, this.chart),
          this.nav.attr({ translateX: f, translateY: b + this.padding + 7 + this.titleHeight, visibility: "visible" }),
          ...
          this.chart.styledMode ||
            (this.up.attr({ fill: 1 === c ? g.inactiveColor : g.activeColor }),
            this.upTracker.css({ cursor: 1 === c ? "default" : "pointer" }),
            this.down.attr({ fill: c === e ? g.inactiveColor : g.activeColor }),
            this.downTracker.css({ cursor: c === e ? "default" : "pointer" })),
          (this.scrollOffset = -d[c - 1] + this.initialItemY),
    ...
    c.LegendSymbolMixin = {
      drawRectangle: function(b, a) {
        ...
        a.legendSymbol = this.chart.renderer
          .rect(
            e ? (b.symbolWidth - d) / 2 : 0,
            b.baseline - d + 1,
            e ? d : b.symbolWidth,
            d,
            B(b.options.symbolRadius, d / 2)
          )
      ...
      drawLineMarker: function(b) {
        ...
        var u = {};
        this.chart.styledMode ||
          ((u = { "stroke-width": a.lineWidth || 0 }), a.dashStyle && (u.dashstyle = a.dashStyle));
        this.legendLine = f
          .path(["M", 0, b, "L", e, b])
        ...
        d &&
          !1 !== d.enabled &&
          e &&
          ((a = Math.min(B(d.radius, g), g)),
          0 === this.symbol.indexOf("url") && ((d = h(d, { width: c, height: c })), (a = 0)),
          (this.legendSymbol = d = f
            .symbol(this.symbol, e / 2 - a, b - a, 2 * a, 2 * a, d)
            .addClass("highcharts-point")
            .add(p)),
          (d.isMarker = !0));
      }
    };
    (/Trident\/7\.0/.test(q.navigator && q.navigator.userAgent) || f) &&
      g(c.Legend.prototype, "positionItem", function(b, a) {
        var d = this,
          e = function() {
    ...
    t(O.prototype, {
        ...
        d.forEach(function(a) {
          a.isDirty &&
            ("point" === a.options.legendType
              ...
              : k && (k.labelFormatter || k.labelFormat) && (m = !0));
      ...
      applyDescription: function(a, b) {
        ...
        e &&
          ...
          ((c = this.renderer
            ...
            .attr({ align: e.align, class: "highcharts-" + a, zIndex: e.zIndex || 4 })
            .add()),
          (c.update = function(b) {
            d[{ title: "setTitle", subtitle: "setSubtitle", caption: "setCaption" }[a]](b);
          }),
          this.styledMode || c.css(e.style),
          (this[a] = c));
      },
      ...
      getChartSize: function() {
        ...
        this.chartHeight = Math.max(
          0,
          c.relativeLength(a, this.chartWidth) || (1 < this.containerHeight ? this.containerHeight : 400)
        );
      },
      ...
      reflow: function(b) {
        ...
        if (!g && !d.isPrinting && m && e && (k === Q || k === L)) {
          if (m !== d.containerWidth || e !== d.containerHeight)
      ...
      setReflow: function(a) {
        ...
        !1 === a || this.unbindReflow
          ...
          : ((this.unbindReflow = d(Q, "resize", function(a) {
      ...
      drawChartBox: function() {
        ...
        m ||
          ...
          f && (r ? r.animate(J) : (this.plotBGImage = b.image(f, w, p, u, n).add())));
      ...
      linkSeries: function() {
        ...
        b.forEach(function(b) {
          ...
          y(d) &&
            ...
            (b.linkedParent = d),
            (b.visible = n(b.options.visible, d.options.visible, b.visible)));
        });
      ...
      if (!this.renderer.forExport) {
        if (t) {
          if ((this.scrollablePixelsX = t = Math.max(0, t - this.chartWidth))) {
            this.plotWidth += t;
            this.inverted
              ? ((this.clipBox.height += t), (this.plotBox.height += t))
              : ((this.clipBox.width += t), (this.plotBox.width += t));
            var v = { 1: { name: "right", value: t } };
          }
        } else
          z &&
            (this.scrollablePixelsY = t = Math.max(0, z - this.chartHeight)) &&
            ((this.plotHeight += t),
            this.inverted
              ? ((this.clipBox.width += t), (this.plotBox.width += t))
              : ((this.clipBox.height += t), (this.plotBox.height += t)),
            (v = { 2: { name: "bottom", value: t } }));
        v &&
          !f.skipAxes &&
    ...
    f.prototype.applyFixed = function() {
      ...
      B
        ? ((this.fixedDiv = c.createElement(
          ...
          (this.fixedRenderer = f = new c.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight)),
          (this.scrollableMask = f
            .path()
            .attr({
              fill: c
                .color(this.options.chart.backgroundColor || "#fff")
                .setOpacity(F(t.opacity, 0.85))
                .get(),
              zIndex: -1
            })
      ...
      B &&
        (t.scrollPositionX && (this.scrollingContainer.scrollLeft = this.scrollablePixelsX * t.scrollPositionX),
        t.scrollPositionY && (this.scrollingContainer.scrollTop = this.scrollablePixelsY * t.scrollPositionY));
      v = this.axisOffset;
  ...
  M(I, "parts/Point.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.Point.prototype = {
      ...
      applyOptions: function(c, b) {
        ...
        d && (this.y = this[d]);
        this.formatPrefix = (this.isNull = C(this.isValid && !this.isValid(), null === this.x || !t(this.y)))
          ? "null"
          : "point";
      ...
      optionsToObject: function(g) {
        ...
        if (t(g) || null === g) b[e[0]] = g;
          ...
          for (
            !d &&
            g.length > h &&
            ((a = typeof g[0]), "string" === a ? (b.name = g[0]) : "number" === a && (b.x = g[0]), f++);
            n < h;

          )
            (d && void 0 === g[f]) ||
              (0 < e[n].indexOf(".") ? c.Point.prototype.setNestedProperty(b, g[f], e[n]) : (b[e[n]] = g[f])),
              f++,
              n++;
        else
          "object" === typeof g &&
            ((b = g), g.dataLabels && (a._hasPointLabels = !0), g.marker && (a._hasPointMarkers = !0));
        return b;
      },
      ...
      },
      {
        ...
        init: function(a, b) {
          ...
          y(m, function(a, b) {
            c.isFunction(a) &&
              d.eventOptions[b] !== a &&
              (c.isFunction(d.eventOptions[b]) && E(d, b, d.eventOptions[b]), (d.eventOptions[b] = a), g(d, b, a));
          });
            ...
            (a.axisTypes || []).forEach(function(k) {
              d[k].forEach(function(d) {
                ...
                if (b[k] === e.index || (void 0 !== b[k] && b[k] === e.id) || (void 0 === b[k] && 0 === e.index))
                  a.insert(d.series), (a[k] = d), (d.isDirty = !0);
              });
        ...
        setOptions: function(a) {
          ...
          this.stickyTracking = h(
            ...
            this.tooltipOptions.shared && !this.noSharedTooltip ? !0 : k.stickyTracking
          );
          null === f.marker && delete k.marker;
          this.zoneAxis = k.zoneAxis;
          c = this.zones = (k.zones || []).slice();
          (!k.negativeColor && !k.negativeFillColor) ||
            k.zones ||
            ((e = { value: k[this.zoneAxis + "Threshold"] || k.threshold || 0, className: "highcharts-negative" }),
            b || ((e.color = k.negativeColor), (e.fillColor = k.negativeFillColor)),
            c.push(e));
        ...
        getColor: function() {
          this.chart.styledMode
            ...
            : this.getCyclic("color", this.options.color || e[this.type].color, this.chart.options.colors);
        },
        getSymbol: function() {
        ...
        updateData: function(a) {
          ...
          a.forEach(function(a, k) {
            var m = (z(a) && this.pointClass.prototype.optionsToObject.call({ series: this }, a)) || {};
            var r = m.x;
            if (m.id || C(r))
              if (
                ((r = this.findPointIndex(m, g)),
                -1 === r || void 0 === r
                  ? c.push(a)
                  : d[r] && a !== b.data[r]
                  ? (d[r].update(a, !1, null, !1), (d[r].touched = !0), h && (g = r + 1))
                  : d[r] && (d[r].touched = !0),
                !f || k !== r || this.hasDerivedData)
              )
                e = !0;
          }, this);
          ...
          if (!L) {
            ...
            if (x && r > x)
              if (((x = k.getFirstValidPoint(a)), C(x)))
                for (d = 0; d < r; d++) (u[d] = this.autoIncrement()), (n[d] = a[d]);
              else if (v(x))
                if (q) for (d = 0; d < r; d++) (e = a[d]), (u[d] = e[0]), (n[d] = e.slice(1, q + 1));
                else
                  for (
                    y && ((t = y.indexOf("x")), (E = y.indexOf("y")), (t = 0 <= t ? t : 0), (E = 0 <= E ? E : 1)),
                      d = 0;
                    d < r;
                    d++
                  )
              ...
              for (d = 0; d < r; d++)
                void 0 !== a[d] &&
                  ((e = { series: k }),
                  k.pointClass.prototype.applyOptions.apply(e, [a[d]]),
                  k.updateParallelArrays(e, d));
        ...
        generatePoints: function() {
          ...
          for (v = 0; v < h; v++) {
            ...
            if (u) {
              ...
              E.dataGroup.options &&
                ((E.options = E.dataGroup.options), t(E, E.dataGroup.options), delete E.dataLabels);
        ...
        getExtremes: function(a) {
          ...
          for (u = 0; u < d; u++) {
            ...
            n =
              ...
              ((e[u + h] || n) >= g && (e[u - h] || n) <= f);
            if (y && n)
              if ((y = q.length)) for (; y--; ) C(q[y]) && (c[k++] = q[y]);
              else c[k++] = q;
          }
          this.dataMin = G(c);
          this.dataMax = F(c);
        ...
        translate: function() {
          ...
          for (u = 0; u < f; u++) {
            ...
            v(Y) &&
              ((I = Y[0]),
              (F = Y[1]),
              I === t && X.key === M[G].base && (I = h(C(y) && y, g.min)),
              g.positiveValuesOnly && 0 >= I && (I = null),
              (H.total = H.stackTotal = P.total),
              (H.percentage = P.total && (H.y / P.total) * 100),
              (H.stackY = F),
            ...
            H.plotY = F =
              "number" === typeof F && Infinity !== F
                ? Math.min(Math.max(-1e5, g.translate(F, 0, 1, 0, 1)), 1e5)
                : void 0;
        ...
        getClipBox: function(a, b) {
          ...
          a && !1 === d.clip && g
            ? (a = c
                ...
                : { y: -g.pos, height: e.chartHeight, width: e.chartWidth, x: -k.pos })
        ...
        setClip: function(a) {
          ...
          h ||
            (a &&
              ((g.width = 0),
              c && (g.x = b.plotSizeX + (!1 !== d.clip ? 0 : b.plotTop)),
              (b[f + "m"] = l = e.clipRect(
                c ? b.plotSizeX + 99 : -99,
          ...
          if (!1 !== d.clip || a)
            this.group.clip(a || k ? h : b.clipRect), this.markerGroup.clip(l), (this.sharedClipKey = f);
          a ||
            (h.count[this.index] && (delete h.count[this.index], --h.count.length),
            0 === h.count.length &&
              f &&
              b[f] &&
              (k || (b[f] = b[f].destroy()), b[f + "m"] && (b[f + "m"] = b[f + "m"].destroy())));
        },
        animate: function(a) {
          var d = this.chart,
          ...
          if (!1 !== e.enabled || this._hasPointMarkers)
            for (g = 0; g < a.length; g++) {
              ...
              if (q && !l.isNull) {
                ...
                d
                  ? d[v ? "show" : "hide"](v).animate(q)
                  : v &&
                    (0 < q.width || l.hasImage) &&
                    (l.graphic = d = b.renderer.symbol(y, q.x, q.y, q.width, q.height, n ? u : e).add(c));
        ...
        markerAttribs: function(a, b) {
          ...
          b &&
            ...
            (k = h(b && b.radius, d && d.radius, k + ((d && d.radiusPlus) || 0))));
          ...
          a.forEach(function(g, m) {
            ...
            g.isNull && !z(b) && 0 < m
              ...
              : (0 === m || l
                  ? (m = ["M", g.plotX, g.plotY])
                  : e.getPointSpline
                  ? (m = e.getPointSpline(a, g, m))
                  : k
                  ? ((m =
                      1 === k
                        ? ["L", u.plotX, p]
                        : 2 === k
                        ? ["L", (u.plotX + r) / 2, u.plotY, "L", (u.plotX + r) / 2, p]
                        : ["L", r, u.plotY]),
                    m.push("L", r, p))
                  : (m = ["L", r, p]),
                h.push(g.x),
                k && (h.push(g.x), 2 === k && h.push(g.x)),
                f.push.apply(f, m),
                (l = !1));
          });
          f.xMap = h;
        ...
        drawGraph: function() {
          ...
          c.forEach(function(c, k) {
            ...
            f &&
              !e &&
              ((g = { stroke: c[2], "stroke-width": b.lineWidth, fill: (a.fillGraph && a.color) || "none" }),
              c[3]
                ? (g.dashstyle = c[3])
                : "square" !== b.linecap && (g["stroke-linecap"] = g["stroke-linejoin"] = "round"),
              f[h](g).shadow(2 > k && b.shadow));
        ...
        applyZones: function() {
          ...
          if (e.length && (p || u) && q && void 0 !== q.min) {
            ...
            e.forEach(function(e, k) {
              ...
              E = Math.max(c, g);
              q.isXAxis
                ? ((l = { x: v ? E : t, y: 0, width: y, height: n }), z || (l.x = b.plotHeight - l.x))
                : ((l = { x: 0, y: v ? E : t, width: n, height: y }), z && (l.y = b.plotWidth - l.y));
              v &&
                d.isVML &&
                (l = q.isXAxis
                  ? { x: 0, y: L ? t : E, height: l.width, width: b.chartWidth }
        ...
        plotGroup: function(a, b, d, e, c) {
          ...
          k.addClass(
            "highcharts-" +
              ...
              this.type +
              "-series " +
              (z(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") +
  ...
  M(I, "parts/Stacking.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.StackItem.prototype = {
      ...
      render: function(c) {
        ...
        this.label
          ...
          : ((this.label = f.renderer.label(q, null, null, n.shape, null, null, n.useHTML, !1, "stack-labels")),
            (q = {
              text: q,
            ...
            this.label.attr(q),
            f.styledMode || this.label.css(n.style),
      ...
      setOffset: function(c, f, n, q, g) {
        ...
        if (f && b) {
          ...
          q.x = f.alignAttr.x;
          f.attr({ x: q.x, y: q.y });
          B(!g && this.options.crop, !0) &&
            ((a =
              a.isInsidePlot(f.x + (a.inverted ? 0 : -n.width / 2), f.y) &&
              a.isInsidePlot(f.x + (a.inverted ? (c ? -n.width : n.width) : n.width / 2), f.y + n.height)) ||
              f.hide());
        }
      },
    ...
    t.prototype.getStacks = function() {
      ...
      c.series.forEach(function(h) {
        ...
        !h.options.stacking ||
          (!0 !== h.visible && !1 !== c.options.chart.ignoreHiddenSeries) ||
          (h.stackKey = [h.type, B(h.options.stack, ""), f ? n.top : n.left, f ? n.height : n.width].join());
      });
    };
    ...
    H.prototype.setStackedPoints = function() {
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (r = 0; r < q; r++) {
          ...
          p[K][x] ||
            (u[K] && u[K][x]
              ? ((p[K][x] = u[K][x]), (p[K][x].total = null))
              : (p[K][x] = new c.StackItem(E, E.options.stackLabels, k, x, d)));
          K = p[K][x];
          null !== A
            ? ((K.points[m] = K.points[this.index] = [B(K.cumulative, a)]),
              F(K.cumulative) || (K.base = m),
              (K.touched = E.stacksTouched),
              0 < w.index && !1 === this.singleStacks && (K.points[m][0] = K.points[this.index + "," + x + ",0"][0]))
            : (K.points[m] = K.points[this.index] = null);
          "percent" === g
            ? ((k = k ? e : l),
              t && p[k] && p[k][x]
                ? ((k = p[k][x]), (K.total = k.total = Math.max(k.total, K.total) + Math.abs(A) || 0))
                : (K.total = v(K.total + (Math.abs(A) || 0))))
            : (K.total = v(K.total + (A || 0)));
      ...
      c[b + "Stacker"] &&
        [f, "-" + f].forEach(function(a) {
          for (var d = q.length, e, f; d--; )
            if (
              ((e = q[d]), (g = c.getStackIndicator(g, e, c.index, a)), (f = (e = n[a] && n[a][e]) && e.points[g.key]))
            )
              c[b + "Stacker"](f, e, d);
        });
    };
  ...
  M(I, "parts/Dynamics.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.cleanRecursively = function(a, b) {
      var d = {};
      H(a, function(e, g) {
        if (v(a[g], !0) && !a.nodeType && b[g])
          (e = c.cleanRecursively(a[g], b[g])), Object.keys(e).length && (d[g] = e);
    ...
    z(f.prototype, {
      addSeries: function(a, b, d) {
        ...
        a &&
          ((b = y(b, !0)),
          e(g, "addSeries", { options: a }, function() {
            c = g.initSeries(a);
            g.isDirtyLegend = !0;
            g.linkSeries();
      ...
      createAxis: function(a, d) {
        var e = this.options,
          ...
          k = d.redraw,
          f = d.animation;
        d = l(d.axis, { index: this[a].length, isX: "xAxis" === a });
      ...
      showLoading: function(b) {
        ...
        f ||
          ...
          (c.loadingSpan = a("span", { className: "highcharts-loading-inner" }, null, f)),
          q(c, "redraw", l));
        f.className = "highcharts-loading";
        c.loadingSpan.innerHTML = y(b, e.lang.loading, "");
        c.styledMode ||
          (d(f, z(h.style, { zIndex: 10 })),
          d(c.loadingSpan, h.labelStyle),
          c.loadingShown ||
            (d(f, { opacity: 0, display: "" }),
            g(f, { opacity: h.style.opacity || 0.5 }, { duration: h.showDuration || 0 })));
        c.loadingShown = !0;
        l();
      },
      ...
      update: function(a, b, d, g) {
        ...
        this.collectionsWithUpdate.forEach(function(b) {
          if (a[b]) {
            ...
            n(a[b]).forEach(function(a, e) {
              (e = (F(a.id) && k.get(a.id)) || k[b][c ? c[e] : e]) &&
                e.coll === b &&
                (e.update(a, !1), d && (e.touched = !0));
              !e &&
                d &&
                k.collectionsWithInit[b] &&
                (k.collectionsWithInit[b][0].apply(
                  k,
                  [a].concat(k.collectionsWithInit[b][1] || []).concat([!1])
                ).touched = !0);
            });
            d &&
        ...
        r || (t(x) && x !== k.chartWidth) || (t(h) && h !== k.chartHeight)
          ? k.setSize(x, h, g)
          : y(b, !0) && k.redraw(g);
        e(k, "afterUpdate", { options: a, redraw: b, animation: g });
      },
    ...
    z(L.prototype, {
      update: function(a, b, d, c) {
        function e() {
          ...
          v(a, !0) &&
            (f && f.element && a && a.marker && void 0 !== a.marker.symbol && (g.graphic = f.destroy()),
        ...
        var g = this,
          ...
          p = k.options;
        b = y(b, !0);
        !1 === c ? e() : g.firePointEvent("update", { options: a }, e);
      },
      remove: function(a, b) {
    ...
    z(E.prototype, {
      ...
      update: function(a, b) {
        ...
        a = l(
          k,
          E,
          { index: void 0 === k.index ? d.index : k.index, pointStart: y(k.pointStart, d.xData[0]) },
          !n && { data: d.options.data },
          a
        );
        ...
        if (n && this.points) {
          ...
          !1 === L.visible
            ...
            : d._hasPointLabels ||
              ((h = L.marker),
              (u = L.dataLabels),
              h && (!1 === h.enabled || "symbol" in h) && (C.graphic = 1),
              u && !1 === u.enabled && (C.dataLabel = 1));
          this.points.forEach(function(a) {
            a &&
              a.series &&
              (a.resolveColor(),
              Object.keys(C).length && a.destroyElements(C),
              !1 === L.showInLegend && a.legendItem && g.legend.destroyItem(a));
          }, this);
        }
        a.zIndex !== k.zIndex &&
      ...
      { softThreshold: !1, threshold: 0 },
      {
        ...
        getGraphPath: function(c) {
          ...
          var e = function(e, f, k) {
            ...
            void 0 !== p &&
              (q.push({ plotX: L, plotY: null === p ? d : y.getThreshold(p), isNull: h, isCliff: !0 }),
              n.push({ plotX: L, plotY: null === u ? d : y.getThreshold(u), doCurve: !1 }));
          };
          c = c || this.points;
          ...
          for (h = 0; h < c.length; h++) {
            ...
            if (!l || t)
              t || e(h, h - 1, "left"),
                (l && !z && t) || (q.push(c[h]), n.push({ x: h, plotX: L, plotY: E })),
                t || e(h, h + 1, "right");
          }
          h = f.call(this, q, !0, !0);
          n.reversed = !0;
        ...
        drawGraph: function() {
          ...
          this.zones.forEach(function(f, h) {
            H.push([
              "zone-area-" + h,
              "highcharts-area highcharts-zone-area-" + h + " " + f.className,
              f.color || c.color,
              f.fillColor || C.fillColor
            ]);
          });
          H.forEach(function(v) {
            var h = v[0],
              ...
              g = {};
            n
              ? ((n.endX = c.preventGraphAnimation ? null : f.xMap), n.animate({ d: f }))
              : ((g.zIndex = 0),
                (n = c[h] = c.chart.renderer
                  .path(f)
                  .addClass(v[1])
                  .add(c.group)),
                (n.isArea = !0));
            c.chart.styledMode ||
              (g.fill = G(
                v[3],
                z(v[2])
                  .setOpacity(G(C.fillOpacity, 0.75))
                  .get()
              ));
            n[q](g);
            n.startX = f.xMap;
      ...
      {},
      {
        getPointSpline: function(c, f, B) {
          ...
          if (C && !C.isNull && !1 !== C.doCurve && !f.isCliff && B && !B.isNull && !1 !== B.doCurve && !f.isCliff) {
            ...
            q += y;
            n > c && n > v
              ? ((n = Math.max(c, v)), (q = 2 * v - n))
              : n < c && n < v && ((n = Math.min(c, v)), (q = 2 * v - n));
            q > B && q > v
              ? ((q = Math.max(B, v)), (n = 2 * v - q))
              : q < B && q < v && ((q = Math.min(B, v)), (n = 2 * v - q));
            f.rightContX = z;
            f.rightContY = q;
          }
    ...
    f(
      ...
      },
      {
        ...
        getColumnMetrics: function() {
          ...
          !1 === f.grouping
            ? (e = 1)
            : c.chart.series.forEach(function(b) {
                var f = b.yAxis,
                  k = b.options;
                if (
                  b.type === c.type &&
                  (b.visible || !c.chart.options.chart.ignoreHiddenSeries) &&
                  g.len === f.len &&
                  g.pos === f.pos
                ) {
                  if (k.stacking) {
          ...
          var l = Math.min(
              Math.abs(q.transA) * (q.ordinalSlope || f.pointRange || q.closestPointRange || q.tickInterval || 1),
              q.len
            ),
            v = l * f.groupPadding,
            t = (l - 2 * v) / (e || 1);
        ...
        translate: function() {
          ...
          c.points.forEach(function(g) {
            ...
            g.barX = m;
            g.pointWidth = r;
            g.tooltipPos = f.inverted
              ? [b.len + b.pos - f.plotLeft - l, c.xAxis.len - m - n / 2, y]
              : [m + n / 2, l + b.pos - f.plotTop, y];
        ...
        pointAttribs: function(c, f) {
          ...
          f &&
            ((c = C(h.states[f], (c.options.states && c.options.states[f]) || {})),
            (f = c.brightness),
            (d =
              c.color ||
              (void 0 !== f &&
                v(d)
                  .brighten(c.brightness)
                  .get()) ||
              d),
            (e = c[b] || e),
            (l = c[a] || l),
        ...
        drawPoints: function() {
          ...
          c.points.forEach(function(d) {
            ...
            if (z(d.plotY) && null !== d.y) {
              ...
              f.styledMode ||
                e[l](c.pointAttribs(d, d.selected && "select")).shadow(
    ...
    F(
      ...
      },
      {
        ...
        applyJitter: function() {
          ...
          f &&
            this.points.forEach(function(t, v) {
  ...
  M(I, "mixins/centered-series.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    c.CenteredSeriesMixin = {
      ...
      getStartAndEndRadians: function(c, f) {
        ...
        return { start: z * (c + -90), end: z * (f + -90) };
      }
    };
  });
    ...
    n(
      ...
      },
      {
          ...
          c ||
            (a.forEach(function(a) {
              ...
              c &&
                ...
                c.animate({ r: e.r, start: e.start, end: e.end }, b.options.animation));
            }),
            (b.animate = null));
        },
        hasData: function() {
        ...
        getX: function(c, b, a) {
          ...
          return (
            d[0] +
            (b ? -1 : 1) *
              Math.cos(Math.asin(Math.max(Math.min((c - d[1]) / (e + a.labelDistance), 1), -1))) *
              (e + a.labelDistance) +
        ...
        translate: function(g) {
          ...
          for (u = 0; u < k; u++) {
            ...
            r.slicedTranslation = { translateX: Math.round(Math.cos(A) * d), translateY: Math.round(Math.sin(A) * d) };
            var w = (Math.cos(A) * g[2]) / 2;
            var m = (Math.sin(A) * g[2]) / 2;
            r.tooltipPos = [g[0] + 0.7 * w, g[1] + 0.7 * m];
          ...
          c.points.forEach(function(g) {
            ...
            if (!g.isNull && e) {
              ...
              g.delayedRendering
                ...
                : (e.setRadialReference(c.center), b.styledMode || C(!0, l, f), C(!0, l, h, d), e.animate(l));
      ...
      },
      {
        ...
        setVisible: function(c, b) {
          ...
          b = z(b, f);
          c !== a.visible &&
            ((a.visible = a.options.visible = c = void 0 === c ? !a.visible : c),
            ...
            a.legendItem && e.legend.colorizeItem(a, c),
        ...
        connectorShapes: {
          fixedOffset: function(c, b, a) {
            ...
            return ["M", c.x, c.y]
              .concat(
                a.softConnector
                  ? ["C", c.x + ("left" === c.alignment ? -5 : 5), c.y, 2 * d.x - b.x, 2 * d.y - b.y, d.x, d.y]
                  : ["L", d.x, d.y]
              )
              .concat(["L", b.x, b.y]);
          },
  ...
  M(I, "parts/DataLabels.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
      ...
      for (
        ...
        for (h = !1; f--; )
          0 < f &&
            ...
            (b[f - 1].align = 0.5),
            b[f - 1].pos + b[f - 1].size > a && (b[f - 1].pos = a - b[f - 1].size),
            b.splice(f, 1),
            (h = !0));
      }
      n.push.apply(n, p);
      ...
      b.some(function(b) {
        ...
        if (
          b.targets.some(function() {
            n[f].pos = b.pos + e;
            if (Math.abs(n[f].pos - n[f].target) > d)
              return (
                n.slice(0, f + 1).forEach(function(a) {
                  delete a.pos;
                }),
                (n.reducedLen = (n.reducedLen || a) - 0.1 * a),
                n.reducedLen > 0.1 * a && c.distribute(n, a, d),
                !0
              );
            e += n[f].size;
            f++;
        ...
        h.forEach(function(c) {
          ...
          p.forEach(function(a, g) {
            ...
            if (k) {
              ...
              var u = a.rotation;
              e.styledMode ||
                ((n.color = v(a.color, n.color, d.color, "#000000")),
                "contrast" === n.color &&
                  ((c.contrastColor = A.getContrast(c.color || d.color)),
                  (n.color = (!G(p) && a.inside) || 0 > p || f.stacking ? c.contrastColor : "#000000")),
              ...
              ? k &&
                ...
                (h
                  ...
                  : ((c.dataLabels = c.dataLabels || []),
                    (h = c.dataLabels[g] = u
                      ? A.text(r, 0, -9999).addClass("highcharts-data-label")
                      : A.label(r, 0, -9999, a.shape, null, null, a.useHTML, null, "data-label")),
                    g || (c.dataLabel = h),
                    h.addClass(
                ...
                (h.options = a),
                h.attr(q),
                e.styledMode || h.css(n).shadow(a.shadow),
                h.added || h.add(w),
                a.textPath &&
                  !a.useHTML &&
                  h.setTextPath((c.getDataLabelPath && c.getDataLabelPath(h)) || c.graphic, a.textPath),
                d.alignDataLabel(c, h, a, null, m))
              : ((c.dataLabel = c.dataLabel && c.dataLabel.destroy()),
                c.dataLabels && (1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[g]),
                g || delete c.dataLabel,
                l &&
                  ((c.connector = c.connector.destroy()),
                  c.connectors && (1 === c.connectors.length ? delete c.connectors : delete c.connectors[g])));
          });
        });
      }
    ...
    n.prototype.alignDataLabel = function(b, a, d, c, f) {
      var e = this.chart,
        ...
        A =
          this.visible &&
          (b.series.forceDL ||
            e.isInsidePlot(h, Math.round(l), g) ||
            (c && e.isInsidePlot(h, g ? c.x + 1 : c.y + c.height - 1, g))),
        w = "justify" === v(d.overflow, "justify");
      if (A) {
        var m = e.renderer.fontMetrics(e.styledMode ? void 0 : d.style.fontSize, a).b;
        c = z({ x: g ? this.yAxis.len - l : h, y: Math.round(g ? this.xAxis.len - h : l), width: 0, height: 0 }, c);
        z(d, { width: k.width, height: k.height });
        n
          ? ((w = !1),
            (h = e.renderer.rotCorr(m, n)),
            (h = {
              x: c.x + d.x + c.width / 2 + h.x,
              y: c.y + d.y + { top: 0, middle: 0.5, bottom: 1 }[d.verticalAlign] * c.height
            }),
            a[f ? "attr" : "animate"](h).attr({ align: q }),
            (l = (n + 720) % 360),
            (l = 180 < l && 360 > l),
            "left" === q
              ? (h.y -= l ? k.height : 0)
              : "center" === q
              ? ((h.x -= k.width / 2), (h.y -= k.height / 2))
              : "right" === q && ((h.x -= k.width), (h.y -= l ? 0 : k.height)),
            (a.placed = !0),
            (a.alignAttr = h))
          : (a.align(d, null, c), (h = a.alignAttr));
        w && 0 <= c.height
          ? this.justifyDataLabel(a, d, h, k, c, f)
          : v(d.crop, !0) && (A = e.isInsidePlot(h.x, h.y) && e.isInsidePlot(h.x + k.width, h.y + k.height));
        if (d.shape && !n)
          a[f ? "attr" : "animate"]({
    ...
    n.prototype.justifyDataLabel = function(b, a, d, c, f, g) {
      ...
      n = d.y + c.height - k;
      n > e.plotHeight &&
        ("top" === l ? ((a.verticalAlign = "bottom"), (a.inside = !0)) : (a.y = e.plotHeight - n), (q = !0));
      q && ((b.placed = !g), b.align(a, null, f));
      return q;
    };
    q.pie &&
      ((q.pie.prototype.dataLabelPositioners = {
      ...
      (q.pie.prototype.drawDataLabels = function() {
        ...
        b.visible &&
          ...
          n.prototype.drawDataLabels.apply(b),
          a.forEach(function(a) {
            a.dataLabel &&
              (a.visible
                ? (H[a.half].push(a),
                  ...
                  !G(f.style.width) &&
                    ...
                    a.dataLabel.getBBox().width > r &&
                    (a.dataLabel.css({ width: 0.7 * r }), (a.dataLabel.shortened = !0)))
            ...
            if (l) {
              ...
              if (0 < b.maxLabelDistance) {
                ...
                a.forEach(function(a) {
                  0 < a.labelDistance &&
                    a.dataLabel &&
                    ((a.top = Math.max(0, m - w - a.labelDistance)),
                    (a.bottom = Math.min(m + w + a.labelDistance, e.plotHeight)),
                    (r = a.dataLabel.getBBox().height || 21),
                    (a.distributeBox = { target: a.labelPosition.natural.y - a.top + r / 2, size: r, rank: a.y }),
              ...
              for (M = 0; M < l; M++) {
                ...
                n &&
                  G(d.distributeBox) &&
                  (void 0 === d.distributeBox.pos
                    ? (N = "hidden")
                    : ((B = d.distributeBox.size), (D = P.radialDistributionY(d))));
                ...
                t._attr = { visibility: N, align: C.alignment };
                ...
                v(f.crop, !0) &&
                  ...
                  (q = null),
                  I - z < g && 1 === h
                    ? ((q = Math.round(z - I + g)), (R[3] = Math.max(q, R[3])))
                    : I + z > p - g && 0 === h && ((q = Math.round(I + z - p + g)), (R[1] = Math.max(q, R[1]))),
                  0 > D - B / 2
                    ? (R[0] = Math.max(Math.round(-D + B / 2), R[0]))
                    : D + B / 2 > u && (R[2] = Math.max(Math.round(D + B / 2 - u), R[2])),
                  (t.sideOverflow = q));
              }
            }
          }),
              ...
              if ((t = a.dataLabel) && t._pos && a.visible && 0 < a.labelDistance) {
                ...
                if ((d = !q))
                  (a.connector = q = e.renderer
                    ...
                    e.styledMode || q.attr({ "stroke-width": h, stroke: W.connectorColor || a.color || "#666666" });
          ...
          a &&
            ...
            ((d = a._pos)
              ? (a.sideOverflow &&
                  ...
                  (a.shortened = !0)),
                a.attr(a._attr),
                a[a.moved ? "animate" : "attr"](d),
                (a.moved = !0))
              : a && a.attr({ y: -9999 }));
          delete b.distributeBox;
        }, this);
      }),
      (q.pie.prototype.alignDataLabel = f),
      (q.pie.prototype.verifyDataLabelOverflow = function(b) {
        var a = this.center,
          d = this.options,
          c = d.center,
          f = d.minSize || 80,
        ...
        if (!g) {
          ...
          null !== c[1]
            ? (n = Math.max(Math.min(n, a[2] - Math.max(b[0], b[2])), f))
            : ((n = Math.max(Math.min(n, a[2] - b[0] - b[2]), f)), (a[1] += (b[0] - b[2]) / 2));
          n < a[2]
            ? ((a[2] = n),
              (a[3] = Math.min(h(d.innerSize || 0, n), n)),
              this.translate(a),
    ...
    q.column &&
      (q.column.prototype.alignDataLabel = function(b, a, d, c, f) {
  ...
  M(I, "modules/overlapping-datalabels.src.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    B(f, "render", function() {
      ...
      (this.series || []).forEach(function(f) {
        ...
        f.visible &&
          (!1 !== v.enabled || f._hasPointLabels) &&
          f.points.forEach(function(f) {
            f.visible &&
              (F(f.dataLabels) ? f.dataLabels : f.dataLabel ? [f.dataLabel] : []).forEach(function(h) {
                var n = h.options;
    ...
    f.prototype.hideOverlappingLabels = function(c) {
      ...
      var g = function(a) {
        ...
        if (a && (!a.alignAttr || a.placed)) {
          ...
          f = a.parentGroup;
          a.width ||
            ((d = a.getBBox()), (a.width = d.width), (a.height = d.height), (d = y.fontMetrics(null, a.element).h));
          return {
      ...
      for (n = 0; n < v; n++) {
        ...
        for (h = n + 1; h < v; ++h) {
          ...
          !b ||
            ...
            a.y > b.y + b.height ||
            a.y + a.height < b.y ||
            ((g.labelrank < q.labelrank ? g : q).newOpacity = 0);
        }
      }
      c.forEach(function(a) {
        var b;
          ...
          a.oldOpacity !== d &&
            (a.alignAttr && a.placed
              ? (d
                ...
                t(f, "afterHideOverlappingLabels"))
              : a.attr({ opacity: d }));
          a.isOld = !0;
        }
      });
    ...
    var E = (c.TrackerMixin = {
      ...
      drawTrackerGraph: function() {
        var a = this,
          ...
          z = "rgba(192,192,192," + (I ? 0.0001 : 0.002) + ")";
        if (e && !d)
          for (t = e + 1; t--; )
            "M" === c[t] && c.splice(t + 1, 0, c[t + 1] - n, c[t + 2], "L"),
        ...
        q(this, "pan", { originalEvent: a }, function() {
          ...
          ("xy" === b ? [1, 0] : [1]).forEach(function(b) {
            ...
            b.series.length &&
              g !== l.min &&
              p !== l.max &&
              (b.setExtremes(g, p, !1, !1, { trigger: "pan" }), (e = !0));
            c[d] = f;
          });
          e && c.redraw(!1);
        ...
        if (
          ...
          if (this.graphic) {
            ...
            if (a && h) {
              ...
              if (z)
                if (p) p[b ? "animate" : "attr"]({ x: z.x, y: z.y });
                else
                  d &&
                    ((c.stateMarkerGraphic = p = t.renderer.symbol(d, z.x, z.y, z.width, z.height).add(c.markerGroup)),
                    (p.currentSymbol = d));
          ...
          a && a.size && p && "hidden" !== e
            ? (y || (c.halo = y = t.renderer.path().add(p.parentGroup)),
              y.show()[b ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
              y.attr({
                class:
                  "highcharts-halo highcharts-color-" +
                  v(this.colorIndex, c.colorIndex) +
                  (this.className ? " " + this.className : ""),
                visibility: e,
                zIndex: -1
              }),
              (y.point = this),
              t.styledMode || y.attr(G({ fill: this.color || c.color, "fill-opacity": a.opacity }, a.attributes)))
            : y && y.point && y.point.haloPath && y.animate({ d: y.point.haloPath(0) }, null, y.hide);
    ...
    G(e.prototype, {
      ...
      setState: function(a, b) {
        ...
        if (
          ...
          if (e && !e.dashstyle)
            for (g = { "stroke-width": h }, e.animate(g, n); c["zone-graph-" + d]; )
  ...
  M(I, "parts/Responsive.js", [I["parts/Globals.js"], I["parts/Utilities.js"]], function(c, f) {
    ...
    f.prototype.setResponsive = function(f, t) {
      ...
      y = y.toString() || void 0;
      y !== (h && h.ruleIds) &&
        (h && this.update(h.undoOptions, f, !0),
        y
          ? ((h = this.currentOptions(t)),
            (h.isResponsiveOptions = !0),
            (this.currentResponsive = { ruleIds: y, mergedOptions: t, undoOptions: h }),
            this.update(t, f, !0))
    ...
    f.prototype.matchResponsiveRule = function(c, f) {
      ...
      (
        ...
        function() {
          return (
            this.chartWidth <= B(t.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= B(t.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= B(t.minWidth, 0) &&
            this.chartHeight >= B(t.minHeight, 0)
          );
        }
      ...
      function f(c, n, q, g) {
        ...
        z(c, function(a, c) {
          if (!g && -1 < v.collectionsWithUpdate.indexOf(c))
            for (a = t(a), q[c] = [], b = 0; b < a.length; b++)
